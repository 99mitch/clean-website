...
export default async function RecrutementPage() {
  ...
  return (
    <>
      ...
      <Section tone="frost" labelledBy="offre-titre">
        <SectionHeader id="offre-titre" title={copy.ceQueNousOffrons} tone="frost" />
      ...
      <Section labelledBy="offres-titre">
        <SectionHeader id="offres-titre" title={copy.offres} />
        {offres.length === 0 ? (
          <p className="mt-8 max-w-[60ch] text-17 text-slate">
            {copy.offresVides}
          </p>
        ) : (
          <ul className="mt-12 grid list-none divide-y divide-steel/30 border-y border-steel/30">
              ...
              <Reveal as="li" key={offre.meta.slug} delay={index * 60}>
                ...
                >
                  <div className="md:col-span-8">
                    <h3 className="text-21 group-hover:text-navy">
                      {offre.meta.title}
                    </h3>
