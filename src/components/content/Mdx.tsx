...
const components = {
  ...
  li: (props: ComponentProps<'li'>) => (
    <li
      {...props}
      className="relative pl-6 text-17 text-slate before:absolute before:left-0 before:top-[0.7em] before:h-px before:w-3 before:bg-graphite marker:font-mono marker:text-slate [ol>&]:pl-0 [ol>&]:before:hidden"
    >
      {frText(props.children)}
    </li>
  ),
